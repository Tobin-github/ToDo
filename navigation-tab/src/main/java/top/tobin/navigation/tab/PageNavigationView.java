...
import top.tobin.navigation.R;
import top.tobin.navigation.tab.internal.CustomItemLayout;
import top.tobin.navigation.tab.internal.CustomItemVerticalLayout;
import top.tobin.navigation.tab.internal.MaterialItemLayout;
import top.tobin.navigation.tab.internal.MaterialItemVerticalLayout;
import top.tobin.navigation.tab.internal.Utils;
import top.tobin.navigation.tab.item.BaseTabItem;
import top.tobin.navigation.tab.item.MaterialItemView;
import top.tobin.navigation.tab.item.OnlyIconMaterialItemView;
import top.tobin.navigation.tab.listener.OnTabItemSelectedListener;
...
public class PageNavigationView extends ViewGroup {
    ...
    public class CustomBuilder {
         ...
         * 添加一组导航按钮
         */
        public CustomBuilder addItems(List<BaseTabItem> baseTabItems) {
            items.clear();
            items.addAll(baseTabItems);
            return CustomBuilder.this;
        }
    ...
    public class MaterialBuilder {
            ...
            if (enableVerticalLayout) {//垂直布局
                ...
                for (MaterialItemViewData data : itemDatas) {
                    ...
                    materialItemView.initialization(
                            ...
                            doTintIcon,
                            defaultColor,
                            changeBackground ? Color.WHITE : data.chekedColor
                    );
         ...
         * @return {@link MaterialBuilder}
         */
        public MaterialBuilder addItem(@DrawableRes int drawableRes,
                                       @DrawableRes int checkedDrawableRes,
    ...
    private class Controller implements BottomLayoutController {
        ...
        public void setupWithViewPager(ViewPager2 viewPager) {
            ...
            if (mNavigationController != null) {
                int n = mViewPager2.getCurrentItem();
            ...
            if (animator == null) {
                if (mEnableVerticalLayout) {// 垂直布局向左隐藏
                    animator = ObjectAnimator.ofFloat(
                            PageNavigationView.this,
                            "translationX",
                            0,
                            -PageNavigationView.this.getWidth()
                    );
                } else {// 水平布局向下隐藏
                    animator = ObjectAnimator.ofFloat(
                            PageNavigationView.this,
                            "translationY",
                            0,
                            PageNavigationView.this.getHeight());
                }
