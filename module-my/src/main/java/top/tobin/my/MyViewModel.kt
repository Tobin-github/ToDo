...
sealed interface IMyAction {
    data class UpdateAddedList(val adapterData: List<String>) : IMyAction
...
class MyViewModel @Inject constructor(
    ...
    private val _randPicture = MutableLiveData<String>()
    val randPicture = _randPicture as LiveData<String>


    override fun initState(): MyUiState {
        return MyUiState(cardList = "")
    }
}